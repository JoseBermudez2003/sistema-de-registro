...
$(document).ready(function () {
    // ESTE ARCHIVO FUE CREADO UNICAMENTE PARA LA VISTA DE LISTACASOS, YA QUE
    // NECESITABA UN CONTROL SOBRE LOS SELECT AL MOMENTO DE DESCARGAR PDF, EXCEL...
    $('#myTable').DataTable({
        language: {
                ...
                exportOptions: {
                    ...
                    format: {
                        header: function (data, columnIdx) {
                            if (columnIdx === 3) return 'Motivo';
                            if (columnIdx === 4) return 'Atendido';
                            if (columnIdx === 5) return 'Fecha de registro';
