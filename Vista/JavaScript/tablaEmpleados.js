$(document).ready(function () {
    ...
    //esta tabla esta para la vista de administrar empleados, y esta unicamente por la cuestion de los pdf
    //ya que los pdf si los centraba se veian mal, pero si lo dejo asi se ven bien, pero
    //me perjudicaba a las otras tablas, asi que cree esto
    //si, este codigo existe unicamente para que se vean los pdfs, lol
    $('#myTable').DataTable({
        language: {
